    ...
    public partial class Form1 : Form
    {
      ...
      public static  int a = 11;
       public static int b = 1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           result = MessageBox.Show( "      Spelare: " + j + "        Dator: " + k,"Poäng"  , MessageBoxButtons.OK, MessageBoxIcon.None);
            if (result == DialogResult.OK)
            {
                ...
                while (w ==1)
                {
                    // Spelarens dragning av fler kort
                    ...
                    if (result2 != DialogResult.Yes)
                    {
                        ...
                        if (k > o)
                        {
                            MessageBox.Show("Datorn gick över gränsen för max antal poäng, du vann", "Du vann", MessageBoxButtons.OK, MessageBoxIcon.None);
                            w = 0;
        ...
        {
            MessageBox.Show("Du och datorn kommer att få två slumpmäsiga kort med värdena mellan 1 och 10 Efter det får du val att dra fler kort med slumpmäsiga värden mellan 1 och 10 tills du är nöjd, då är det datorns tur att dra kort.                                                                                                                                                            Målet är att ha ett högre värde än datorn och vara så nära värdet 21 som möjligt utan att gå över.om du går över värdet 21 eller om datorn har ett högre number än dig utan att ha gått över 21 så förlorar du. Som standard kommer datorn att fortsätta dra kort tills den vunnit eller gått över 21.                                                                                                                                                        I inställnings alternaivet kan du ändra saker som svårighetsgrad och max/min värde av korten för att göra spelet svårare eller enklare och i senaste vinnare allternativet kan du se vem som vann mot datorn senast", "Regler", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
